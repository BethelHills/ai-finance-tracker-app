...
import { MockDataGenerator, MockUser, MockAccount, MockTransaction, MockRecipient } from './mock-data';
...
export function SimulationProvider({ children }: { children: React.ReactNode }) {
  ...
  const addTransaction = (transactionData: Omit<MockTransaction, 'id'>) => {
    ...
    updateAccountBalance(transactionData.accountId, 
      accounts.find(a => a.id === transactionData.accountId)?.balance || 0 + transactionData.amount
    );
  };
