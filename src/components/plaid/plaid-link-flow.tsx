...
export function PlaidLinkFlow() {
  ...
  const steps = [
    ...
    },
    {
      id: 'institution',
      title: 'Select Bank',
      description: 'Choose your financial institution',
    },
    {
      id: 'link',
      title: 'Link Account',
    ...
    },
    {
      id: 'sync',
      title: 'Sync Data',
      description: 'Import transactions and balances',
    },
  ...
  const handlePlaidLinkSuccess = async (publicToken: string) => {
    try {
      ...
      toast.success('Bank account linked and transactions synced');
    } catch (error) {
      setSyncStatus('error');
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Connect your bank account to automatically sync transactions and get
          AI-powered insights
        </CardDescription>
      </CardHeader>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div className='flex items-start space-x-3'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-600'>
                256-bit encryption and read-only access
              </p>
            </div>
          </div>
          ...
          <div className='flex items-start space-x-3'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-600'>
                Automatic transaction updates and balance tracking
              </p>
            </div>
          </div>
          ...
          <div className='flex items-start space-x-2'>
            ...
            <div>
              ...
              <p className='text-sm text-blue-800 mt-1'>
                We can only view your transactions and balances. We cannot move
                money or make changes to your account.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          You'll be redirected to {institution?.name} to securely authenticate
          your account
        </CardDescription>
      </CardHeader>
      <CardContent className='space-y-6'>
          ...
          <div className='flex items-start space-x-2'>
            ...
            <div>
              ...
              <p className='text-sm text-green-800 mt-1'>
                You'll be redirected to your bank's secure login page. We never
