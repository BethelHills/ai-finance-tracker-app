...
export function NigerianPaymentFlow() {
  ...
  const loadBanks = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/nigerian-payments/banks?provider=${selectedProvider}`);
      if (response.ok) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: `Payment link generated: ${data.paymentLink}`,
        });
      }
    } catch (error) {
      toast({
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: `Transfer reference: ${data.reference}`,
        });
      }
    } catch (error) {
      toast({
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              className={`p-4 border rounded-lg cursor-pointer transition-colors ${
                selectedProvider === 'paystack' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
              }`}
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Nigeria's leading payment processor</p>
                </div>
              </div>
            </div>
            ...
            <div
              className={`p-4 border rounded-lg cursor-pointer transition-colors ${
                selectedProvider === 'flutterwave' ? 'border-green-500 bg-green-50' : 'border-gray-200'
              }`}
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Pan-African payment platform</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800 mt-1">
                All payments are processed securely through {provider === 'paystack' ? 'Paystack' : 'Flutterwave'} 
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <div className="text-2xl font-bold text-gray-900">₦10,000,000</div>
