      ...
      <CardContent className="space-y-4">
        {insights.map((insight) => (
          <div
            ...
            className={cn(
              ...
              selectedInsight?.id === insight.id ? "ring-2 ring-primary" : "hover:bg-accent/50"
            )}
                ...
                {selectedInsight?.id === insight.id && (
                  <div className="mt-3 p-3 bg-muted rounded-md">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-blue-700">AI Recommendation:</p>
                        <p className="text-sm text-muted-foreground mt-1">
        ...
        <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border">
          ...
          <p className="text-sm text-muted-foreground">
            Based on your spending patterns, you're doing well with your savings rate of 26.7%. 
            The AI recommends focusing on optimizing your dining expenses and considering the 
            grocery store switch to maximize your savings potential.
          </p>
        </div>
      </CardContent>
    </Card>
