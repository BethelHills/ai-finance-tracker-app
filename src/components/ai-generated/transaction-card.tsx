...
export function TransactionCard({
  ...
  const confidenceColor = aiConfidence > 0.8 ? 'text-green-600' : 
                         aiConfidence > 0.6 ? 'text-yellow-600' : 'text-red-600'
  
  const confidenceIcon = aiConfidence > 0.8 ? CheckCircle : 
                        aiConfidence > 0.6 ? AlertTriangle : AlertTriangle
