          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-sm text-purple-700">
                Save ${savingsPotential.toFixed(2)} per month with these recommendations
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-2">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-4 bg-white rounded-lg border">
          <div className="flex items-center justify-between mb-2">
            <h4 className="font-medium text-gray-900">Monthly Savings Potential</h4>
            <div className="flex items-center space-x-2">
          ...
          <Progress 
            value={(savingsPotential / (Object.values(currentBudget).reduce((a, b) => a + b, 0) * 0.1)) * 100} 
            className="h-2"
          />
          <p className="text-xs text-gray-600 mt-1">
            {((savingsPotential / Object.values(currentBudget).reduce((a, b) => a + b, 0)) * 100).toFixed(1)}% of total budget
          </p>
        </div>
              ...
              <div key={category} className="flex items-center justify-between p-3 bg-white rounded-lg border">
                <div className="flex-1">
                  <div className="flex items-center space-x-2">
                    ...
                    {savings > 0 && (
                      <Badge variant="outline" className={cn("text-xs", savingsColor)}>
        ...
        {isExpanded && (
          <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
            <div className="flex items-start space-x-2">
              ...
              <div>
                <h5 className="text-sm font-medium text-purple-900 mb-1">AI Analysis</h5>
