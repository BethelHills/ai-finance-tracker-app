  ...
  aiInsights: [
    {
      ...
      description:
        'Your dining expenses increased by 25% compared to last month, spending $1,200 vs $960.',
      impact: 'high',
      recommendation:
        'Consider setting a monthly dining budget of $1,000 to maintain your savings goals.',
    ...
    },
    {
      ...
      description:
        'You saved $150 on transportation this month by using public transit more often.',
      impact: 'positive',
      recommendation:
        'Continue this trend to save an estimated $1,800 annually.',
      savingsPotential: 0,
    },
    {
      type: 'goal_progress',
      ...
      description:
        "You're 78% towards your $10,000 emergency fund goal with $7,800 saved.",
      impact: 'high',
      recommendation:
        "At your current savings rate, you'll reach your goal in 2.3 months.",
      savingsPotential: 0,
    },
  ],
  goals: [
              ...
              >
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <div className='flex items-center space-x-1'>
                    ...
                    <span
                      className={`text-sm ${getTrendColor(category.trend)}`}
                    >
                      {category.trend === 'up'
                        ? '↗'
                        : category.trend === 'down'
