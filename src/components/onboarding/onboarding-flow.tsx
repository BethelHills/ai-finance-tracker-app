...
export function OnboardingFlow() {
    ...
    setPermissions([
      {
        ...
        description:
          'Read-only access to your account balances and transaction history',
        required: true,
        granted: false,
        category: 'banking',
      },
  ...
  const completeOnboarding = async () => {
    ...
    try {
      ...
      toast.success('Your AI Finance Tracker is ready to use');
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
        <div className='flex items-start space-x-3'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-600'>
              Read-only access to sync your transactions
            </p>
          </div>
        </div>
        ...
        <div className='flex items-start space-x-3'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-600'>
              Smart categorization and financial analysis
            </p>
          </div>
        </div>
    ...
    <div className='space-y-6'>
      <div className='text-center mb-6'>
        ...
        <p className='text-gray-600'>
          We need your permission to provide secure financial services. All data
        ...
        <div className='flex items-start space-x-2'>
          ...
          <div>
            ...
            <p className='text-sm text-blue-800 mt-1'>
              We use bank-level encryption (AES-256) and never store your
              banking credentials. All data access is read-only and follows
