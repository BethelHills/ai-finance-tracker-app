...
const aiFeatures = [
  { name: 'Smart Categorization', description: 'AI-powered transaction sorting' },
  { name: 'Predictive Analytics', description: 'Forecast spending patterns' },
  { name: 'Budget Optimization', description: 'AI-recommended budget adjustments' },
  { name: 'Investment Insights', description: 'Market analysis and recommendations' },
]
