      ...
      <div className='grid gap-6 md:grid-cols-2'>
        ...
        <Card className='md:col-span-2'>
          <CardHeader>
            ...
            <CardDescription>
              Track your spending patterns week by week
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='h-80'>
          ...
          <div className='grid gap-4 md:grid-cols-2'>
            <div className='p-4 border rounded-lg'>
              ...
              <p className='text-sm text-muted-foreground mb-2'>
                You're spending 15% more on dining than last month. Consider
                setting a monthly dining budget.
              </p>
            ...
            <div className='p-4 border rounded-lg'>
              ...
              <p className='text-sm text-muted-foreground mb-2'>
                You're 78% towards your emergency fund goal. Keep up the great
                work!
              </p>
              <Button size='sm' variant='outline'>
                View Goals
            ...
            <div className='p-4 border rounded-lg'>
              ...
              <p className='text-sm text-muted-foreground mb-2'>
                Consider investing your extra $2,300 monthly savings for
                long-term growth.
              </p>
              <Button size='sm' variant='outline'>
                Explore Options
