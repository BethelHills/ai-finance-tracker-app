            ...
            {accounts.map((account) => (
              <div key={account.id} className="p-4 border rounded-lg">
                ...
                <div className="text-sm text-muted-foreground">
                  {account.type.charAt(0).toUpperCase() + account.type.slice(1)} • {account.provider}
                </div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-32 bg-gray-200 rounded-full h-2">
                    <div 
                      ...
                      style={{ width: `${(category.amount / topCategories[0].amount) * 100}%` }}
                    />
                  </div>
      ...
      <Card className="border-yellow-200 bg-yellow-50">
        <CardContent className="pt-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-medium text-yellow-800">Simulation Mode Active</span>
          </div>
          <p className="text-sm text-yellow-700 mt-1">
            You're viewing simulated financial data. All transactions, accounts, and balances are generated for demonstration purposes only.
