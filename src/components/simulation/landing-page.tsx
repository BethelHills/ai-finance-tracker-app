      ...
      <div className='container mx-auto px-6 py-20'>
        <div className='text-center max-w-4xl mx-auto'>
          ...
          <p className='text-xl text-gray-600 mb-8 max-w-2xl mx-auto'>
            Experience the future of personal and business finance with
            AI-powered insights, multi-currency support, and global payment
            integration. All in a safe simulation environment.
          </p>
      ...
      <div className='container mx-auto px-6 py-20'>
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
            Everything you need to manage your finances with confidence and
            intelligence
          </p>
        </div>
          ...
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-yellow-700 mb-6 max-w-2xl mx-auto'>
                This is a demonstration version of our AI Finance Tracker. All
                data shown is simulated and no real financial information is
                processed. Experience the full functionality without any risk to
      ...
      <div className='container mx-auto px-6 py-20'>
        <div className='text-center'>
          ...
          <p className='text-lg text-gray-600 mb-8 max-w-2xl mx-auto'>
            Start the simulation to explore all features and see how AI can
