...
const mockData = {
  ...
  netWorth: 45620.3,
  creditScore: 785,
  investmentValue: 12340.2,
  emergencyFund: 8500.0,
  monthlyTrend: 12.5,
  aiInsights: [
    {
      id: 1,
    ...
    <div className='space-y-6'>
      ...
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Welcome back! Here's your comprehensive financial overview with AI
            insights.
          </p>
        </div>
      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              ${mockData.investmentValue.toLocaleString()}
            </div>
            <p className='text-xs text-muted-foreground'>+12.4% this year</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              ${mockData.emergencyFund.toLocaleString()}
            </div>
            <p className='text-xs text-muted-foreground'>8.5 months expenses</p>
          </CardContent>
        </Card>
      </div>
